...
<br><br><br><br>
    ...
    <tbody>
        <tr>
            ...
            <input type="text" id="name" size ="100" name = "name" value="name" placeholder="Ingrese su nombre" style="width: 170px"></td>
        ...
        <tr>
            ...
            <td width="210" style="height: 25px; width: 138px;">
            <input type="text" id="lastname" name ="lastname"size ="100" value="lastname"placeholder="Ingrese sus Apellidos" style="width: 170px"></td>
            <td width="40" style="height: 25px">
                <span style="color: #ff0000">(*)</span>
            </td>
        </tr>
          <tr>
            ...
            <td width="210" style="height: 25px; width: 138px;">
            <input type="text" id="ciudad" size ="100" name = "ciudad" value="ciudad" placeholder="Ciudad" style="width: 170px"></td>
            <td width="40" style="height: 25px">
                <span style="color: #ff0000">(*)</span>
            </td>
        </tr>
        <tr>
            ...
            <td width="210" style="height: 25px; width: 138px;">
            <input type="text" id="direccion" name ="direccion"size ="100" value="direccion" placeholder="Ingrese su Direccion" style="width: 170px"></td>
            <td width="40" style="height: 25px">
                <span style="color: #ff0000">(*)</span>
            </td>
        </tr>
        <tr>
            ...
            <td width="210" style="height: 25px; width: 138px;">
            <input type="text" id="dni" name ="dni"size ="100" value="dni" placeholder="Ingrese su DNI" style="width: 170px"></td>
            <td width="40" style="height: 25px">
                <span style="color: #ff0000">(*)</span>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="height: 26px">
              <input type="text" id="cui" name = "cui" value="cui" placeholder="Ingrese su CUI">
            </td>
                <td style="height: 26px;">
